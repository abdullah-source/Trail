// Synchronous SHA-256 (the analysis must be a pure synchronous function). Byte-identical to
// hashlib.sha256 over UTF-8 input; used for text hashes, event hashes and canonical JSON.
