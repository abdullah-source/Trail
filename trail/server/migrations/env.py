"""Alembic environment. The URL comes from DATABASE_URL (Railway Postgres) or falls back to the
local SQLite file, exactly as the app does (trail.server.settings)."""
...
if config.config_file_name is not None:
    # keep the app's loggers alive when migrations run in-process (tests, scripts)
